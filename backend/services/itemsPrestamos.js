...
async function insertDataPrestamos (req, res) {
...
//Función con la consulta de obtener datos de la base de datos: select * from prestamos
async function getDataPrestamos (req, res) {
...
async function deleteDataPrestamos (req, res) {
